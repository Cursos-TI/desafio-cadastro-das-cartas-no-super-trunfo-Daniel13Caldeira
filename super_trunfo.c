...
int main()
{
    ...
    printf("\n\nComparacao de Cartas: (atributo: PIB per capta)\nCarta 1 - %s: %.2f\nCarta 2 - %s: %.2f\nResultado: ",nomeCidade1,pibPerCapto1,nomeCidade2,pibPerCapto2);
    if(pibPerCapto1>pibPerCapto2){
        printf("Carta 1 (%s) venceu!",nomeCidade1);
    }else{
        if(pibPerCapto2 > pibPerCapto1){
            printf("Carta 2 (%s) venceu!",nomeCidade2);
        }else{
            printf("Empate!");
        }
    ...
    printf("\n\nComparacao de Cartas: (atributo: Super Poder)\nCarta 1 - %s: %.2f\nCarta 2 - %s: %.2f\nResultado: ",nomeCidade1,superPoder1,nomeCidade2,superPoder2);
